...
(function (c, g) {
  ...
  function G() {
    var b =
      0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : document;
      ...
      b.WeakMap = (function () {
        ...
        function c(b, d) {
          if (Object(b) !== b || !a.call(b, "_id"))
            throw new TypeError(
              d + " method called on incompatible receiver " + typeof b
            );
        }
        ...
        function c() {
          for (var a = 0; a < this.chain.length; a++) {
            ...
            try {
              !1 === e
                ? f.reject(this.msg)
                : ((c = !0 === e ? this.msg : e.call(void 0, this.msg)),
                  c === f.promise
        ...
        b._onMessage = function (a) {
          if (l(a.origin) && b.element.contentWindow === a.source)
            if (
              ...
              (e = a && "ping" === a.method),
                (a && "ready" === a.event) || e
                  ? (b.element.setAttribute("data-ready", "true"), d())
                  : K(b, a);
        };
    ...
    g(c, [
      ...
      },
      {
        ...
        value: function (a, c) {
          ...
          0 === b(this, "event:".concat(a)).length &&
            this.callMethod("addEventListener", a).catch(function () {});
      ...
      },
      {
        ...
        value: function (a, b) {
          ...
          return this.callMethod("enableTextTrack", { language: a, kind: b });
        },
      },
      {
