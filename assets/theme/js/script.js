...
(function () {
  ...
  function w(a) {
    ...
    return !(
      !b.length || !navigator.userAgent.match(new RegExp(b.join("|"), "i"))
    );
  }
  function B(a) {
  ...
  function y(a) {
    ...
    null === a.getAttribute("id") &&
      (b = a.classList.value.match(/cid-.*?(?=\s|$)/) + "-carousel");
    ...
    a.querySelector(".carousel-controls") &&
      a.querySelectorAll(".carousel-controls").forEach(function (a) {
        a.querySelectorAll("a").forEach(function (a) {
          ...
          d
            ? a.setAttribute("data-bs-target", "#" + b)
            : a.setAttribute("data-target", "#" + b);
        });
      });
  ...
  function G(a) {
    ...
    if (d) {
      ...
      for (var k = 0; k < d.length; k++)
        b.push('"' + d[k].getAttribute("stop-color") + '"');
      b = '"lineargradient": [' + b + "],";
  ...
  function z(a, b, d) {
    ...
    g.getAttribute("style") ||
      g.setAttribute("style", "-webkit-flex-basis: auto; flex-basis: auto;");
            ...
            if (d && /youtu\.?be/g.test(d[3])) {
              ...
              h.onload = function () {
                if (120 === (h.naturalWidth || h.width)) {
                  ...
                  (c.style.backgroundImage = 'url("' + h.src + '")'),
                    (c.style.display = "block");
              ...
              if (d && /vimeo/g.test(d[3])) {
                ...
                m.open(
                  "GET",
                  "https://vimeo.com/api/v2/video/" + d[6] + ".json",
                  !0
                );
                ...
                b.element.style.marginLeft =
                  "-" + (b.element.scrollWidth - m.scrollWidth) / 2 + "px";
        ...
        e(document).on("changeParameter.cards", function (a, b, d, c) {
          if ("bg" === b)
            switch (
              ...
              (b.style.position = ""),
              e(a.target).find(".mbr-background-video-preview").remove(),
              e(a.target).find(".mbr-background-video").remove(),
              c)
            ) {
              case "type":
    ...
    if (t)
      e(document).on("add.cards delete.cards", function (a) {
        ...
        k = setTimeout(function () {
          ...
          a &&
            ((r = { breakPoint: f(a).top + 3 * c(a), fixed: !1, elm: a }),
              ...
              if (b.hash) {
                ...
                document
                  ...
                  .forEach(function (d) {
                    ...
                    h =
                      "#bottom" == b.hash
                        ? c(d) - window.innerHeight
                        : f(d).top - h;
                    d.classList.contains("panel-collapse") ||
                      d.classList.contains("tab-pane") ||
        ...
        function b() {
          ...
          if (k && g) {
            ...
            e > b &&
              ((b = (100 * (e - b)) / b),
              (d.style.width = b + 100 + "%"),
              (d.style.maxWidth = b + 100 + "%"),
              (d.style.marginLeft = -b / 2 + "%"));
          }
        }
        ...
        var a = function () {
            ...
            c.forEach(function (c) {
              ...
              ((e + h >= a && e - 50 <= g) || b(c)) &&
                ...
                c.classList.add("animate__fadeInUp"),
                c.classList.add("animate__delay-1s"),
                c.addEventListener(
      ...
      var a = function (a) {
        ...
        b = function (b) {
          ...
          var e = b.parents("section")[0],
            f = e.querySelector(
              e.querySelector("[data-modal]").getAttribute("data-modal")
            );
        ...
        (v.querySelectorAll("ul.navbar-nav li.dropdown").forEach(function (a) {
          a.addEventListener("mouseover", function () {
            a.classList.contains("open") &&
              a.querySelector("a").dispatchEvent(new CustomEvent("click"));
          });
          ...
          a.addEventListener("click", function () {
            ...
            !d.classList.contains("collapsing") ||
              ...
              (a.classList.contains("collapsed")
                ? (c.classList.remove("mbri-arrow-up"),
                  c.classList.add("mbri-arrow-down"))
                : (c.classList.remove("mbri-arrow-down"),
                  c.classList.add("mbri-arrow-up")),
    ...
    e(document)
      ...
      .on("changeParameter.cards", function (a, b, c) {
        "testimonialsSlides" === b &&
          0 == e(a.target).find(".carousel-item.active").length &&
          B(a.target);
      });
  else
    "undefined" === typeof window.initTestimonialsPlugin &&
...
!(function () {
  ...
  if (!document.getElementById("top-1")) {
    ...
    a.style = "display: none";
    a.innerHTML =
      '<a href="https://mobirise.in">mobirise.com</a> Mobirise v5.6.0';
